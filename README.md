# WTM Fresno and GDG Fresno landing page

Using Feeling Responsive Jekyll theme.
Right now blog is disabled until SquareSpace material transformation. In the future limited support for multiple languages as well.
